...
export const getNotificationSettings = (): NotificationSettings => 
  JSON.parse(localStorage.getItem(localStorageId) || 'null').notificationSettings || {}

export const setNotificationSettings = (notificationSettings:NotificationSettings) => {
  const stored = JSON.parse(localStorage.getItem(localStorageId) || 'null');
  localStorage.setItem(localStorageId, JSON.stringify({...stored, notificationSettings}))
}